...
public class QUIZ extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(D, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, 700, 61));
        ...
        getContentPane().add(B, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, 700, 67));
        ...
        getContentPane().add(C, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, 700, 59));
        ...
        getContentPane().add(A, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 700, 61));
        ...
        num.setText("    ");
        getContentPane().add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 70, 80));

        ques.setEditable(false);
        ques.setColumns(20);
        ques.setFont(new java.awt.Font("Noto Sans", 1, 18)); // NOI18N
        ques.setRows(5);
        jScrollPane1.setViewportView(ques);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, 690, -1));
